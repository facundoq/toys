...
public class BufferPool {
    ...
    Page[] pages;
    Hashtable<PageId,Page> pageIdToHeapPage;
    /**
     * Constructor.
     *
    ...
    public BufferPool(int numPages) {
       ...
       pageIdToHeapPage = new Hashtable<PageId, Page>();       
    }
    ...
    public synchronized Page getPage(TransactionId tid, PageId pid, Permissions perm)
    	...
    	Page page;
    	if (this.pageIdToHeapPage.containsKey(pid)){
    		page = this.pageIdToHeapPage.get(pid);
    	}else{
    		DbFile dbFile = Database.getCatalog().getDbFile(pid.tableid());
    		page = dbFile.readPage(pid);
    		pageIdToHeapPage.put(pid, page);
    	}
        return page;
    }
