 ...
 * 
 */
public class SmallerComparisonOperator extends BaseComparisonOperator {
	...
	public static ComparisonOperator newComparisonOperator() {
		return new SmallerComparisonOperator();
	}
