...
import org.crappydbms.queries.predicates.simple.comparison.GreaterComparisonOperator;
 ...
 * 
 */
public abstract class GreaterPredicateFactory  {
	
	public static ComparisonOperator getComparisonOperator(){
		return GreaterComparisonOperator.newComparisonOperator();
	}
	
	public static SimplePredicate newPredicate(Field firstField, Field secondField){
		return new FieldFieldPredicate(firstField,secondField, GreaterPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(Field field, String attributeName){
		return new FieldAttributePredicate(field,attributeName,GreaterPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(String attributeName,Field field){
		return new AttributeFieldPredicate(attributeName,field,GreaterPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(String firstAttributeName,String secondAttributeName){
		return new AttributeAttributePredicate(firstAttributeName,secondAttributeName,GreaterPredicateFactory.getComparisonOperator());
	}
