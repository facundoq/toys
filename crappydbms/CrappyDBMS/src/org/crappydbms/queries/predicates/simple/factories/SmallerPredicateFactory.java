...
import org.crappydbms.queries.predicates.simple.comparison.SmallerComparisonOperator;
 ...
 * 
 */
public abstract class SmallerPredicateFactory  {
	
	public static ComparisonOperator getComparisonOperator(){
		return SmallerComparisonOperator.newComparisonOperator();
	}
	
	public static SimplePredicate newPredicate(Field firstField, Field secondField){
		return new FieldFieldPredicate(firstField,secondField, SmallerPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(Field field, String attributeName){
		return new FieldAttributePredicate(field,attributeName,SmallerPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(String attributeName,Field field){
		return new AttributeFieldPredicate(attributeName,field,SmallerPredicateFactory.getComparisonOperator());
	}
	public static SimplePredicate newPredicate(String firstAttributeName,String secondAttributeName){
		return new AttributeAttributePredicate(firstAttributeName,secondAttributeName,SmallerPredicateFactory.getComparisonOperator());
	}
}
