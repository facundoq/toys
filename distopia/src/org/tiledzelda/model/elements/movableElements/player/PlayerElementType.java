...
import org.tiledzelda.model.elements.movableElements.MovableElementType;
...
public class PlayerElementType extends MovableElementType {
	...
	public PlayerElementType(String name, MovableElementCharacteristics movableElementCharacteristics) {
		super(name, movableElementCharacteristics);
	}
