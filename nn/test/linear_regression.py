...
utils.plot_history(history, results_dir /f"linear_regression_{dataset_name}_history.png")
if din ==1 and dout ==1:
    utils.plot_model_dataset_1d(x,y,model,results_dir/ f"linear_regression_{dataset_name}_model.png")
