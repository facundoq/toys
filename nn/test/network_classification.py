...
utils.plot_history(history, results_dir / f"logistic_regression_{dataset_name}_history.png")
...
if din ==2:
    utils.plot_model_dataset_2d_classification(x,y,model,results_dir/f"logistic_regression_    {dataset_name}_model.png")
